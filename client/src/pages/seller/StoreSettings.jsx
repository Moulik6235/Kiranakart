                ...
                <div className="bg-indigo-50 border border-indigo-100 rounded-2xl p-5 mb-8">
                    ...
                    <div className="space-y-2 text-sm">
                        <div className="flex justify-between text-gray-700">
                            <span>Item subtotal</span><span className="font-bold">₹XXX</span>
                        </div>
                        {deliveryEnabled && (
                            <div className="flex justify-between text-gray-700">
                        ...
                        {surgeEnabled && (
                            <div className="flex justify-between text-gray-700">
                                <span>{surgeLabel || 'Surge charge'}</span>
                                <span className="font-bold text-gray-900">₹{surgeCharge}</span>
                            </div>
                        )}
                        <div className="border-t border-indigo-200 pt-2 flex justify-between font-black text-gray-900">
                            <span>Grand Total</span>
                            <span>₹XXX + ₹{(deliveryEnabled ? Number(deliveryCharge) : 0) + (surgeEnabled ? Number(surgeCharge) : 0)}</span>
                        </div>
                    </div>
                </div>
